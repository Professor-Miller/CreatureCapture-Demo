...
IL_000f:
	{
		ParticleU5BU5D_tE2CC7CC8844B6F592CC26DE7B533D8BC74C9BEC7* L_2 = ___0_particles;
		if (!L_2)
		{
			G_B5_0 = G_B2_0;
			goto IL_002b;
	...
	}
	{
		...
		V_1 = L_3;
		ParticleU5BU5D_tE2CC7CC8844B6F592CC26DE7B533D8BC74C9BEC7* L_4 = V_1;
		NullCheck(L_4);
	...
	}
	{
		...
		NullCheck(L_5);
		uintptr_t L_6 = (il2cpp_codegen_conv<uintptr_t,Particle_tF16C89682A98AB276CCBE4DA0A6E82F98500F79D*,intptr_t,false,false>(((L_5)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))),NULL));
		...
		BlittableArrayWrapper__ctor_mD7869B76C6745D311B8FD895EF3C29428E568971_inline((&V_0), (void*)L_6, L_8, NULL);
		G_B5_0 = G_B4_0;
	}
...
IL_002b:
	{
		...
		ParticleSystem_SetParticles_Injected_m92D51D65E031E0EDFB1B35F9802687DC8CAB320A(G_B5_0, (&V_0), L_9, L_10, NULL);
		return;
	}
}
